...
const App: React.FC = () => {
  ...
  return (
    <>
      ...
      <main>
        {/* history section */}
        <section className="z-888 mt-20 md:mt-10 lg:mt-20">
          <HistorySection />
        </section>

        {/* message section */}
        <section className="mt-10 md:mt-0 lg:mt-30">
          <Message />
        </section>
        ...
        {/* blogs section */}
        <section className="flex flex-col w-full mx-auto py-2 h-auto lg:h-[90dvh] mt-30 lg:mt-50 flex border-y-5 border-gray-300 md:mt-40">
          <h1 className="text-[38px] lg:text-header text-center lg:text-left font-semibold  w-5/6 mx-auto flex items-center justify-center lg:items-left lg:justify-end lg:mt-[-90px]">
            Blogs
          </h1>
          <Slider />
        </section>
        ...
        <section className="relative w-full mx-auto h-auto lg:h-[100dvh] mt-20 flex lg:mt-20 md:mt-35">
          ...
          {/* slider */}
          <section className="w-5/6 mx-auto h-10/12">
            <h1 className="text-[38px] lg:text-header text-center lg:text-left font-semibold mx-auto flex items-center justify-center lg:items-left lg:justify-start mb-5 lg:mb-0">
              Events
            </h1>

            <EventSlider slides={sliderData} />
          </section>
        </section>
      </main>
