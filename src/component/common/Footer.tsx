...
const Footer: React.FC = () => {
  return (
    <>
      <footer className="w-5/6 mx-auto flex flex-col lg:flex-row gap-8 lg:gap-5 h-auto">
        {/* info */}
        <section className="w-full lg:w-1/2 flex flex-col gap-8 lg:gap-6 justify-between lg:pr-20">
          {/* logo section */}
          <section className="w-full flex flex-col gap-5">
            ...
            <hr className="w-full lg:w-4/5 text-xl bg-primary h-[3px] rounded-full border-0" />

            <p className="text-ternary text-sm text-justify lg:text-left lg:text-lg">
          ...
          <div className="w-full flex justify-between">
            <section className="w-1/2 text-white flex flex-col gap-2">
              <h2 className="text-ternary teext-sm lg:text-base">Address</h2>
          ...
          <section className="w-full flex flex-col gap-2">
            <h2 className="text-ternary text-base">Follow</h2>
          ...
          {/* links */}
          <section className="w-full flex flex-col gap-2">
            <h2 className="text-ternary text-base">Quick links</h2>
            <div className="w-full">
              <div className="space-x-6">
                <nav className="flex flex-row md:flex-row justify-left items-start md:items-center lg:space-x-4 space-x-5 text-white text-xs md:text-sm text-left">
                  <Link className="h-full flex items-center" to="/">
                    <a
                      href="#"
                      className="hover:text-primary hover:cursor-pointer flex items-center lg:px-3"
                    >
                      About
                    </a>
                  </Link>
        ...
        {/* map */}
        <section className="w-full lg:w-1/2 lg:pt-25 flex flex-col gap-2">
          <h2 className="text-ternary text-base">Find Location</h2>
          <iframe
